...
var tests = []testCaseTmpl{
	...
	},
	{
		context: "opf-title",
		tmpl:    []byte(titleTemplate),
		fb2:     []byte(fb2_no_series),
		result:  "Тестовая книга",
	},
	{
...
func TestTemplates(t *testing.T) {
	...
	for i, c := range tests {
		...
		p, err := NewFB2(bytes.NewReader(c.fb2), false, "path1/path2/file.fb2", "/path3/path4", false, false, false, OEpub, env)
		if err != nil {
...
const fb2_no_series = `<?xml version="1.0" encoding="utf-8"?>
<FictionBook xmlns="http://www.gribuser.ru/xml/fictionbook/2.0" xmlns:l="http://www.w3.org/1999/xlink">
